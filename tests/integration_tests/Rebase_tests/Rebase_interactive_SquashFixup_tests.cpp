...
class RebasInteractiveSquashFixupTest : public RebaseFixture
{
};

TEST_F(RebasInteractiveSquashFixupTest, stop)
{
...
TEST_F(RebasInteractiveSquashFixupTest, continue_noChangeMessage)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
...
TEST_F(RebasInteractiveSquashFixupTest, breakAfter)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
...
TEST_F(RebasInteractiveSquashFixupTest, squashFixupAfterBreak_breakAfter)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
...
TEST_F(RebasInteractiveSquashFixupTest, conflictOnFixup_stop)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
...
TEST_F(RebasInteractiveSquashFixupTest, conflictOnFixup_continue)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
    ...
    indexManager.add("file1.txt");
    const auto continueRebaseResult = rebaser.continueRebase("New msg", "New desc");
...
TEST_F(RebasInteractiveSquashFixupTest, conflictOnFixup_breakAfter)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
...
TEST_F(RebasInteractiveSquashFixupTest, conflictOnSquash_stop)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
...
TEST_F(RebasInteractiveSquashFixupTest, conflictOnSquash_continue)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
...
TEST_F(RebasInteractiveSquashFixupTest, conflictOnSquash_breakAfter)
{
    const auto rebaser = repository->Rebaser();
    const auto commitsManager = repository->CommitsManager();
    const auto indexManager = repository->IndexManager();
